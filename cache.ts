...
export function getCache<T extends object>(cache: Map<string, T>, id: string): T | null {
...
export function setCache<T extends object>(cache: Map<string, T>, id: string, u: T) {
  const d = cache.get(id);
  if (d) {
